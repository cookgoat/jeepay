...
public class SysUserAuthService extends ServiceImpl<SysUserAuthMapper, SysUserAuth> {
   ...
   **/
  @Transactional
  public void addUserAuthDefault(Long userId, String loginUserName, String telPhone, String pwdRaw,
      String sysType) {
   ...
   */
  @Transactional
  public void resetAuthInfo(Long resetUserId, String authLoginUserName, String telphone,
      String newPwd, String sysType) {
...
//        }
    ...
    if (StringUtils.isNotEmpty(newPwd)) {
      ...
      List<SysUserAuth> authList = list(SysUserAuth.gw().eq(SysUserAuth::getSysType, sysType)
  ...
  public boolean validateCurrentUserPwd(String pwdRaw) {
    ...
    SysUserAuth auth = getOne(SysUserAuth.gw()
        .eq(SysUserAuth::getUserId,
            JeeUserDetails.getCurrentUserDetails().getSysUser().getSysUserId())
